...
<html class="wide wow-animation" lang="en">
  <head>
    ...
    <meta charset="utf-8">
    <link rel="icon" href="../dileep/images/favicon.ico" type="image/x-icon">
    <!-- Stylesheets-->
    <link rel="stylesheet" type="../dileep/text/css" href="//fonts.googleapis.com/css?family=Lato:400,700,400italic%7CPoppins:300,400,500,700">
    <link rel="stylesheet" href="../dileep/css/bootstrap.css?v=1.0">
    <link rel="stylesheet" href="../dileep/css/style.css?v=1.0">
  ...
  <body>
          ...
          <nav class="rd-navbar rd-navbar-default-with-top-panel" data-layout="rd-navbar-fixed" data-sm-layout="rd-navbar-fixed" data-md-layout="rd-navbar-fullwidth" data-md-device-layout="rd-navbar-fixed" data-lg-layout="rd-navbar-fullwidth" data-lg-device-layout="rd-navbar-fullwidth" data-md-stick-up-offset="90px" data-lg-stick-up-offset="150px" data-stick-up="true" data-sm-stick-up="true" data-md-stick-up="true" data-lg-stick-up="true">
            <div class="rd-navbar-top-panel rd-navbar-collapse">
              <div class="rd-navbar-top-panel-inner">
                ...
                <div class="center-side">
                  <!-- RD Navbar Brand-->
                  <div class="rd-navbar-brand fullwidth-brand"><a class="brand-name" href="index.html"><img src="../logo/riverview.png" alt="" width="314" height="48"/></a></div>
                </div>
            ...
            <div class="rd-navbar-inner">
              ...
              <div class="rd-navbar-panel">
                ...
                <!-- RD Navbar Brand-->
                <div class="rd-navbar-brand mobile-brand"><a class="brand-name" href="index.html"><img src="../logo/riverview.png" alt="" width="314" height="48"/></a></div>
              </div>
              ...
              <section class="section">
                ...
                <div class="swiper-container swiper-slider swiper-style-2" data-loop="false" data-autoplay="5500" data-simulate-touch="false" data-slide-effect="slide" data-direction="vertical">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide" data-slide-bg="../dileep/slide/slide_1.jpg">
                    ...
                    <div class="swiper-slide" data-slide-bg="../dileep/slide/slide_2.jpg">
                      <div class="swiper-slide-caption">
                        <div class="shell text-sm-left">
                    ...
                    <div class="swiper-slide" data-slide-bg="../dileep/slide/slide_3.jpg">
                      <div class="swiper-slide-caption">
                        <div class="shell text-sm-left">
                  ...
                  <div class="range range-sm-bottom spacing-20">
                    ...
                    <div class="cell-lg-12 cell-md-4 cell-sm-6">
                      ...
                      <div class="form-wrap">
                        ...
                        <input class="form-input" id="date-in" data-time-picker="date" type="text" name="date" data-constraints="">
                      </div>
                    </div>
                    <div class="cell-lg-12 cell-md-4 cell-sm-6">
                      ...
                      <div class="form-wrap">
                        ...
                        <input class="form-input" id="date-out" data-time-picker="date" type="text" name="date" data-constraints="">
                      </div>
                    </div>
                    <div class="cell-lg-6 cell-md-4 cell-xs-6">
                      ...
                      <div class="form-wrap form-wrap-validation">
                        <!--Select 2-->
                        <select class="form-input select-filter" data-minimum-results-search="-1" data-placeholder="1" data-constraints="">
                          <option>&nbsp;</option>
                    ...
                    <div class="cell-lg-6 cell-md-4 cell-xs-6">
                      ...
                      <div class="form-wrap form-wrap-validation">
                        <!--Select 2-->
                        <select class="form-input select-filter" data-minimum-results-search="-1" data-placeholder="0" data-constraints="">
                          <option>&nbsp;</option>
      ...
      <section class="section section-md bg-white text-center text-sm-left">
        <div class="shell-wide">
          <div class="range range-50 range-xs-center overflow-hidden">
            <div class="cell-sm-10 cell-md-7 cell-lg-7 wow fadeInUp" data-wow-delay=".1s">
              {{-- <div class="post-video post-video-border">
                <div class="post-video__image"><img src="../dileep/images/video-bg-1020x525.jpg" alt="" width="1020" height="525"/>
                </div>
                <div class="post-video__body"><a class="link-control post-video__control" data-lightgallery="item" href="https://www.youtube.com/watch?v=qENgZjIrrqs"></a></div>
              </div> --}}
              <iframe width="100%" height="100%" src="https://www.youtube.com/embed/qENgZjIrrqs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
            <div class="cell-sm-10 cell-md-5 cell-lg-5 reveal-flex wow fadeInUp" data-wow-delay=".3s">
          ...
          <div class="range range-50 range-md-justify range-sm-middle">
            ...
            <div class="cell-sm-6">
              <div class="box-outline box-outline__mod-1">
                <figure><img src="../dileep/food/food.jpg" alt="" width="546" height="516"/>
                </figure>
              </div>
            </div>
          </div>
          ...
          <div class="isotope-wrap">
            ...
            <div class="row isotope" data-isotope-layout="masonry" data-isotope-group="gallery" data-lightgallery="group">
              ...
              <div class="col-xs-12 col-sm-6 col-md-3 isotope-item wow fadeInUp" data-filter="Category 1" data-wow-delay=".1s">
                <a class="portfolio-item thumbnail-classic" href="../{{$it->image}}" data-size="533x800" data-lightgallery="item">
                <img src="../{{$it->thumbnail}}" alt="" width="420" height="584"/>
                  <figure></figure>
        ...
        <div class="shell-wide">
          ...
          <div class="owl-carousel owl-carousel-stagePadding" data-items="1" data-sm-items="2" data-xl-items="3" data-dots="false" data-nav="true" data-stage-padding="0" data-lg-stage-padding="100" data-xl-stage-padding="0" data-loop="true" data-margin="30" data-mouse-drag="false" data-nav-class="[&quot;owl-button-prev fl-budicons-free-left161&quot;,&quot;owl-button-next  fl-budicons-free-right163&quot;]">
            <div class="post-box post-box-minimal post-box-horizontal wow fadeInUp" data-wow-delay=".1s"><a class="post-box-image" href="blog-post.html">
                <figure><img src="../dileep/images/layout-2-blog-01-460x369.jpg" alt="" width="460" height="369"/>
                </figure></a>
            ...
            <div class="post-box post-box-minimal post-box-horizontal wow fadeInUp" data-wow-delay=".2s"><a class="post-box-image" href="blog-post.html">
                <figure><img src="../dileep/images/layout-2-blog-02-460x369.jpg" alt="" width="460" height="369"/>
                </figure></a>
              <div class="post-box-minimal-caption">
                <div class="post-box-minimal-caption-inner">
            ...
            <div class="post-box post-box-minimal post-box-horizontal wow fadeInUp" data-wow-delay=".3s"><a class="post-box-image" href="blog-post.html">
                <figure><img src="../dileep/images/layout-2-blog-03-460x369.jpg" alt="" width="460" height="369"/>
                </figure></a>
              <div class="post-box-minimal-caption">
                <div class="post-box-minimal-caption-inner">
    ...
    <!-- Javascript-->
    <script src="../dileep/js/core.min.js"></script>
    <script src="../dileep/js/script.js"></script>
    <!--Coded by Drel-->
  </body>
</html>